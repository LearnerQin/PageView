...
protocol QinTitleViewDelegate : class {
    func titleView(_ titleView : QinTitleView, targetIndex : Int)
}


class QinTitleView: UIView {

    weak var delegate : QinTitleViewDelegate?
    ...
    init(frame: CGRect, titles : [String], style : QinTitlesStyle) {
        self.titles = titles
        self.style = style
...
// MARK:- 遵守QinContentViewDelegate
extension QinTitleView : QinContentViewDelegate{
